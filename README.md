...
- **개발 기간:** 2023.06.28~2023.06.30(총 3일)
...
- 그 외 프로젝트 관련 사항은 노션 페이지 프로젝트란에 기록하기
...
- crud 기능 구현 예정
  login 기능 확인
- 로그인 사용자와 아닌 사용자 헤더 분리 확인
- 로그인 기능 구현 완료  
  
2023.06.25 - 김경규
- 조원평가 등록 기능 구현 완료
- 조원평가 페이지 등록 ID를 파이어베이스 레퍼런스 아이디로 사용 - 완료
- 조원평가페이지에서 코멘트 등록 기능 구현 - 완료
- 등록된 코멘트가 내가 등록한 페이지에서만 보여지는지 확인 - 완료
- 권한없는 사용자가 admin페이지로 들어가지 않도록 인터셉터 구현 - 완료
- 파이어베이스 일부 기능 변경 및 추가
- Board - 모든 게시글을 가져오는 기능이 추가됨
